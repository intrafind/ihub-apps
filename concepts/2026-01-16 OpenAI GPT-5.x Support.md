...
Extended `modelConfigSchema` to support GPT-5.x configuration:
- Added `gpt5Reasoning` schema with:
  - `effort`: enum of 'none', 'low', 'medium', 'high', 'xhigh' (default: 'medium')
  - `verbosity`: enum of 'low', 'medium', 'high' (default: 'medium')
