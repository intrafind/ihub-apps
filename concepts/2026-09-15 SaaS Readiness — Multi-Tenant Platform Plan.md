...
**Exit:** one process serves two tenants in the integration suite with zero cross-tenant reads; a self-hosted install upgraded to this release has a byte-identical `contents/` and identical behaviour.
