  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} maxWidthClassName="max-w-2xl">
      <DetailsPopupHeader
        ...
        iconStyle={{ backgroundColor: getProviderColor(model.provider) }}
        title={getLocalizedContent(model.name, currentLanguage)}
        subtitle={model.id}
        onClose={onClose}
      />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
              ...
              <div className="text-sm text-gray-900 dark:text-gray-100 mt-1">{model.provider}</div>
            </div>
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
              <div className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">
        ...
        {model.url && (
          <div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
              ...
              <div className="text-sm text-gray-900 dark:text-gray-100 break-all">{model.url}</div>
            </div>
          </div>
        )}
        ...
        {apps.length > 0 && (
          <div>
            ...
            <div className="space-y-2">
              {apps.map(app => (
                <div key={app.id} className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <div
      ...
      <DetailsPopupFooter>
        ...
        <button
          onClick={onClose}
          className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-md hover:bg-gray-50 dark:hover:bg-gray-500 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
        >
