...
const AppUsageCard = ({ data }) => {
  ...
  const total = apps.reduce(
    (sum, [, value]) =>
      sum + (typeof value === 'object' ? (value.total || (value.good || 0) + (value.bad || 0)) : value),
    0
  );
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            {Object.entries(feedback.perApp || {}).map(([app, appFeedback]) => {
              ...
              return (
                <div key={app} className="p-4 border rounded-lg bg-gray-50">
                  ...
                  {totalModelFeedback > 0 && (
                    <div className="text-center">
                      <div className="flex items-center justify-center space-x-2 mb-2">
                        ...
                        <span className="text-xl font-bold text-amber-600">{averageRating.toFixed(1)}</span>
                      </div>
