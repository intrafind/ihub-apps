                      ...
                      <div className="space-y-4 pl-6">
                        ...
                        <div>
                          <div className="flex items-center mb-2">
                            <input
                              type="checkbox"
                              checked={app.upload?.videoUpload?.enabled || false}
                              onChange={e =>
                                handleInputChange('upload', {
                                  ...app.upload,
                                  videoUpload: {
                                    ...app.upload.videoUpload,
                                    enabled: e.target.checked
                                  }
                                })
                              }
                            ...
                            />
                            <label className="ml-2 block text-sm font-medium text-gray-900">
                              {t('admin.apps.edit.enableVideoUpload', 'Enable Video Upload')}
                            </label>
                          </div>
                          {app.upload?.videoUpload?.enabled && (
                            <div className="ml-6 space-y-3">
                              <div className="flex items-center">
                                <input
                                  type="checkbox"
                                  checked={app.upload?.videoUpload?.extractAudio !== false}
                                  onChange={e =>
                                    handleInputChange('upload', {
                                      ...app.upload,
                                      videoUpload: {
                              ...
                              <div>
                                <label className="block text-xs font-medium text-gray-700">
                                  {t('admin.apps.edit.maxVideoSize', 'Max Video File Size (MB)')}
                                </label>
                                <input
                                  type="number"
                                  min="1"
                              ...
                              <div>
                                <label className="block text-xs font-medium text-gray-700 mb-2">
                                  {t(
                                    'admin.apps.edit.supportedVideoFormats',
                                ...
                                <MimeTypeSelector
                                  categoryType="video"
                                  selectedFormats={
                                    app.upload?.videoUpload?.supportedFormats || [
                                      'video/mp4',
                                      'video/webm',
                                      'video/quicktime'
                                    ]
