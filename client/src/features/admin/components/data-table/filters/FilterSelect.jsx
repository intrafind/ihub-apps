  ...
  return (
    ...
    >
      ...
      <select
        ...
        className="text-sm rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 px-2 py-2 focus:outline-hidden focus:ring-2 focus:ring-indigo-500"
      >
        {options.map(opt => (
