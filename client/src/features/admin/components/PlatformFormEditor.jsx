...
import LocalAuthSection from './platform-form/LocalAuthSection';
import NtlmAuthSection from './platform-form/NtlmAuthSection';
import AuthDebugSection from './platform-form/AuthDebugSection';
...
function PlatformFormEditor({ value: config, onChange, onValidationChange }) {
  ...
  return (
    <div className="platform-form-editor space-y-8">
      ...
      {config.localAuth?.enabled && <LocalAuthSection config={config} onChange={onChange} />}
      ...
      {/* NTLM Configuration */}
      {config.ntlmAuth?.enabled && <NtlmAuthSection config={config} onChange={onChange} t={t} />}

      {/* Authentication Debug Settings */}
      <AuthDebugSection config={config} onChange={onChange} />
