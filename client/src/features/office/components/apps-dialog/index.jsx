...
export default function ItemSelectorDialog({ items, isOpen, onSelect, onClose }) {
  ...
  return (
    ...
    >
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-sm sm:max-w-md flex flex-col max-h-[90vh] sm:max-h-[80vh] dark:bg-slate-800">
        <div className="flex items-center justify-between px-3 py-2 sm:px-4 sm:py-3 border-b border-slate-200 shrink-0 dark:border-slate-700">
