 ...
 * nothing in the product reads it yet — it is the groundwork for durable chats.
 *
 * The settings are seeded anyway so the section is visible and editable in
 * Admin → Platform Configuration from the first upgrade, instead of appearing
 * out of nowhere when a later release starts using it:
 *
