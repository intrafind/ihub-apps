...
/**
 * Migration V102 specs — CIMD arrives off, and with a host allowlist.
 *
...
import {
  ...
  version,
  description
} from '../migrations/V102__add_oauth_cimd_defaults.js';
...
describe('V102 — OAuth CIMD defaults', () => {
  before(async () => {
    baseDir = await fs.mkdtemp(path.join(os.tmpdir(), 'ihub-v102-'));
  });
  after(async () => {
