...
console.log('🧪 Testing Anthropic Tool Name Validation Fix\n');

// Test Case 1: Tool with localized name containing spaces and special characters
console.log('Test 1: Tool with localized name (spaces and special characters)');
const localizedTool = {
...
console.log('✓ Localized tool name correctly uses ID: webContentExtractor\n');

// Test Case 2: Tool with English name containing spaces
console.log('Test 2: Tool with name containing spaces');
...
console.log('✓ Tool name with spaces correctly uses ID: enhancedWebSearch\n');

// Test Case 3: Tool without ID (edge case - should fall back to name)
console.log('Test 3: Tool without ID (fallback to name)');
const toolWithoutId = {
  name: 'simpleToolName',
...
console.log('✓ Tool without ID correctly falls back to name: simpleToolName\n');

// Test Case 4: Verify Anthropic pattern compliance
console.log('Test 4: Verify Anthropic pattern compliance');
...
console.log('✓ All tool names match Anthropic pattern: ^[a-zA-Z0-9_-]{1,128}$\n');

// Test Case 5: Multiple tools conversion
console.log('Test 5: Multiple tools batch conversion');
const multipleTools = [
  {
    id: 'braveSearch',
...
console.log('✓ Multiple tools batch conversion successful\n');

console.log('✅ All Anthropic tool name validation tests passed!');
