...
/**
 * Migration V098 specs — seeding the `workflowState` section in platform.json.
 *
...
import { up, precondition, version } from '../migrations/V098__add_workflow_state_retention.js';
