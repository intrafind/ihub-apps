...
/**
 * Migration V119 specs — iAssistant models get room, and a dead key goes.
 *
...
import {
  ...
  version,
  description
} from '../migrations/V119__iassistant_stream_ceiling_and_grounding.js';
...
beforeEach(async () => {
  dir = await fs.mkdtemp(path.join(os.tmpdir(), 'ihub-v119-'));
  await fs.mkdir(path.join(dir, 'models'), { recursive: true });
});
