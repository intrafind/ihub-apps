...
A chat turn allows up to 10 tool rounds, so the model can search several times before it answers.
...
The default **Web Chat** app's prompt was reworded to match. Migration V123 updates an existing
