...
> **This page has moved.**
> All tool documentation, including the built-in tools reference, the tool file field reference, and implementation guides, is now consolidated in the **[Tool Calling Guide](tool-calling.md)**.
